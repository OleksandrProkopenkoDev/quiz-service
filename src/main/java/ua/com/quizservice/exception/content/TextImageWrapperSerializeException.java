 ...
 * @author [Your Name]
 */
public class TextImageWrapperSerializeException extends RuntimeException {

  private static final String ERROR_MESSAGE =
      "Something went wrong during serialization TextImageWrapper : ";

  public TextImageWrapperSerializeException(Exception e) {
